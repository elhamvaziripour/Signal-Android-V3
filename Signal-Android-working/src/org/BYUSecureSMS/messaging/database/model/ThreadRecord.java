...
public class ThreadRecord extends DisplayRecord {
  ...
  public SpannableString getDisplayBody() {
    if (SmsDatabase.Types.isDecryptInProgressType(type)) {
      ...
      return emphasisAdded(context.getString(org.BYUSecureSMS.messaging.R.string.ThreadRecord_called));
    } else if (SmsDatabase.Types.isIncomingCall(type)) {
      return emphasisAdded(context.getString(org.BYUSecureSMS.messaging.R.string.ThreadRecord_called_you));
    } else if (SmsDatabase.Types.isMissedCall(type)) {
      return emphasisAdded(context.getString(org.BYUSecureSMS.messaging.R.string.ThreadRecord_missed_call));

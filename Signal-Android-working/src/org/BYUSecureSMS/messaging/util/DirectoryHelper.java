...
import org.BYUSecureSMS.messaging.sms.IncomingJoinedMessage;
import org.BYUSecureSMS.messaging.util.DirectoryHelper.UserCapabilities.Capability;
...
public class DirectoryHelper {
  ...
  private static Optional<AccountHolder> getOrCreateAccount(Context context) {
    ...
    Account[]      accounts       = accountManager.getAccountsByType("org.BYUSecureSMS.messaging");
  ...
  private static Optional<AccountHolder> createAccount(Context context) {
    AccountManager accountManager = AccountManager.get(context);
    Account        account        = new Account(context.getString(R.string.app_name), "org.BYUSecureSMS.messaging");

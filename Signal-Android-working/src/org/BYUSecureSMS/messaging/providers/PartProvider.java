...
import org.BYUSecureSMS.messaging.mms.PartUriParser;
import org.BYUSecureSMS.messaging.util.Util;
import org.BYUSecureSMS.messaging.service.KeyCachingService;
import org.BYUSecureSMS.messaging.util.MemoryFileUtil;
...
public class PartProvider extends ContentProvider {
  ...
  private static final String CONTENT_URI_STRING = "content://org.BYUSecureSMS.messaging/part";
  ...
  static {
    ...
    uriMatcher.addURI("org.BYUSecureSMS.messaging", "part/*/#", SINGLE_ROW);
  }

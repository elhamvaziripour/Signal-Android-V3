...
public class MmsBodyProvider extends ContentProvider {
  ...
  private static final String CONTENT_URI_STRING = "content://org.BYUSecureSMS.messaging.messaging.mms/mms";
  ...
  static {
    ...
    uriMatcher.addURI("org.BYUSecureSMS.messaging.messaging.mms", "mms/#", SINGLE_ROW);
  }

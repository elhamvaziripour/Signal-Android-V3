...
import org.BYUSecureSMS.messaging.mms.VideoSlide;
import org.BYUSecureSMS.messaging.util.DynamicLanguage;
import org.BYUSecureSMS.messaging.util.SaveAttachmentTask;
import org.BYUSecureSMS.messaging.video.VideoPlayer;
import org.BYUSecureSMS.messaging.components.ZoomingImageView;
import org.BYUSecureSMS.messaging.recipients.Recipient;
import org.BYUSecureSMS.messaging.recipients.Recipient.RecipientModifiedListener;
  ...
  private void saveToDisk() {
    SaveAttachmentTask.showWarningDialog(this, new DialogInterface.OnClickListener() {
      ...
      public void onClick(DialogInterface dialogInterface, int i) {
        ...
        saveTask.execute(new SaveAttachmentTask.Attachment(mediaUri, mediaType, saveDate, null));
      }
    });
  }

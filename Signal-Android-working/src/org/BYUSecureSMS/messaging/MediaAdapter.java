...
import org.BYUSecureSMS.messaging.MediaAdapter.ViewHolder;
...
public class MediaAdapter extends CursorRecyclerViewAdapter<ViewHolder> {
  ...
  public void onBindItemViewHolder(final ViewHolder viewHolder, final @NonNull Cursor cursor) {
    ...
    final MediaDatabase.MediaRecord mediaRecord = MediaDatabase.MediaRecord.from(getContext(), masterSecret, cursor);

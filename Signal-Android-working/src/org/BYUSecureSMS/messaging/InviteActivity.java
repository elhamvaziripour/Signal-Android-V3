    ...
    protected Void doInBackground(String... numbers) {
      ...
      for (String number : numbers) {
        ...
        if (recipients.getPrimaryRecipient() != null) {
          Optional<RecipientPreferenceDatabase.RecipientsPreferences> preferences    = DatabaseFactory.getRecipientPreferenceDatabase(context).getRecipientsPreferences(recipients.getAddresses());

 ...
 */
package org.BYUSecureSMS.messaging.recipients;
...
import org.BYUSecureSMS.messaging.contacts.avatars.ContactPhoto;
...
import org.BYUSecureSMS.messaging.util.LRUCache;
...
class RecipientProvider {
  ...
  private @NonNull RecipientDetails getIndividualRecipientDetails(Context context, @NonNull Address address) {
    Optional<RecipientPreferenceDatabase.RecipientsPreferences> preferences = DatabaseFactory.getRecipientPreferenceDatabase(context).getRecipientsPreferences(new Address[]{address});
  ...
  private @Nullable
  RecipientPreferenceDatabase.RecipientsPreferences getRecipientsPreferencesSync(Context context, Address[] addresses) {
    return DatabaseFactory.getRecipientPreferenceDatabase(context)
                          .getRecipientsPreferences(addresses)
                          .orNull();
  }

  private ListenableFutureTask<RecipientPreferenceDatabase.RecipientsPreferences> getRecipientsPreferencesAsync(final Context context, final Address[] addresses) {

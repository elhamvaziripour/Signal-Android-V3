...
public class ThumbnailView extends FrameLayout {
  ...
  private GenericRequestBuilder buildThumbnailGlideRequest(@NonNull Slide slide, @NonNull MasterSecret masterSecret) {
    ...
    DrawableRequestBuilder<DecryptableStreamUriLoader.DecryptableUri> builder = Glide.with(getContext())
                                                          .load(new DecryptableStreamUriLoader.DecryptableUri(masterSecret, slide.getThumbnailUri()))
                                                          .diskCacheStrategy(DiskCacheStrategy.NONE)
                                                          .crossFade()
                                                          .transform(new RoundedCorners(getContext(), true, radius, backgroundColorHint));

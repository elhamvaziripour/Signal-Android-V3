...
import org.BYUSecureSMS.messaging.components.RecyclerViewFastScroller.FastScrollAdapter;
import org.BYUSecureSMS.messaging.contacts.ContactSelectionListAdapter.HeaderViewHolder;
import org.BYUSecureSMS.messaging.contacts.ContactSelectionListAdapter.ViewHolder;
        ...
        StickyHeaderDecoration.StickyHeaderAdapter<HeaderViewHolder>
{
  ...
  public void onBindItemViewHolder(ViewHolder viewHolder, @NonNull Cursor cursor) {
    ...
    int color = (contactType == ContactsDatabase.PUSH_TYPE) ? drawables.getColor(0, 0xa0000000) :
            drawables.getColor(index, 0xff000000);
